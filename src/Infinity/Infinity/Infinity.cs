...
namespace Infinity
{
    ...
    /// </summary>
    public class Infinity : Microsoft.Xna.Framework.Game
    {
...
//            graphics.IsFullScreen = false;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().GetPressedKeys().Contains(Keys.Escape)) this.Exit();

            debugString = "";
            gameWorld.Update();
            gameWorld.UpdateCamera(player.GamePosition);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(MyContentManager.Font_Debug, debugString, new Vector2(0,0),Color.White );
            spriteBatch.End();
