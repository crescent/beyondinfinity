...
public class MyMath {
	...
	public static long currentTimeInMili()
	{
		return (System.nanoTime()/1000000)%10000;
	}
	
	public static int MapToRange(int value, int min, int max, int newMin, int newMax)
	{
	...
	public static double limitAngleDifference(double angle, double newAngle, double maxAngleDiff) {
		...
		if(diff>maxAngleDiff) diff = maxAngleDiff;
		else if(diff<-maxAngleDiff) diff = -maxAngleDiff;
