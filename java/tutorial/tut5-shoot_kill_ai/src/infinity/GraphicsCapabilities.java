 ...
 * Main frame class.
 */
public class GraphicsCapabilities extends JFrame implements ItemListener {
    ...
    public GraphicsCapabilities(GraphicsDevice dev) {
    ...
    public static void display() {
        ...
        for (int i = 0; i < devices.length; i++) {
            GraphicsCapabilities tst = new GraphicsCapabilities(devices[i]);
            tst.pack();
            tst.setVisible(true);
        }
    }
